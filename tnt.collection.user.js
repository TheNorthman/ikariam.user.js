...
var tnt = {
    ...
    version: "1.4.143", // GM_info.script.version,
    ...
    resource: {
        ...
        toggle: function (el) {
            if ($(el).hasClass("back")) {
                $(el).removeClass("back").addClass("foreward");
            } else {
                $(el).removeClass("foreward").addClass("back");
                tnt.resource.update();
            }
        },
    ...
    template: {
        resources: '<span class="tnt_back"></span><div id="tnt_info_resources"></div>'
    }
};
